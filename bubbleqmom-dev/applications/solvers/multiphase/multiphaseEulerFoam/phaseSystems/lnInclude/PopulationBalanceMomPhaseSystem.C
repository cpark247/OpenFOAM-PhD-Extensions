...
Foam::PopulationBalanceMomPhaseSystem<BasePhaseSystem>::
...
:
    ...
    (
        ...
        diameterModels::populationBalanceMomModel::iNew(*this, dmdtfs_)
    )
{
    forAll(populationBalances_, i)
    {
        const Foam::diameterModels::populationBalanceMomModel& popBal =
        ...
        forAllConstIter(phaseSystem::phasePairTable, popBal.phasePairs(), iter)
        {
            ...
            <
                diameterModels::populationBalanceMomModel
...
Foam::PopulationBalanceMomPhaseSystem<BasePhaseSystem>::dmdtf
(
...
Foam::PopulationBalanceMomPhaseSystem<BasePhaseSystem>::dmdts() const
{
...
Foam::PopulationBalanceMomPhaseSystem<BasePhaseSystem>::momentumTransfer()
{
...
template<class BasePhaseSystem>
Foam::autoPtr<Foam::phaseSystem::momentumTransferTable>
Foam::PopulationBalanceMomPhaseSystem<BasePhaseSystem>::momentumTransferf()
{
    autoPtr<phaseSystem::momentumTransferTable> eqnsPtr =
...
Foam::PopulationBalanceMomPhaseSystem<BasePhaseSystem>::heatTransfer() const
{
...
Foam::PopulationBalanceMomPhaseSystem<BasePhaseSystem>::specieTransfer() const
{
...
template<class BasePhaseSystem>
void Foam::PopulationBalanceMomPhaseSystem<BasePhaseSystem>::solve
(
...
template<class BasePhaseSystem>
void Foam::PopulationBalanceMomPhaseSystem<BasePhaseSystem>::correct()
{
...
template<class BasePhaseSystem>
bool Foam::PopulationBalanceMomPhaseSystem<BasePhaseSystem>::read()
{
