...
Foam::MomentumTransferPhaseSystemExtend<BasePhaseSystem>::Kd
(
...
) const
{
    ...
    {
        return filter_(dragModels_[key]->K());
    }
    else
    {
...
Foam::MomentumTransferPhaseSystemExtend<BasePhaseSystem>::Kdf
(
    const phasePairKey& key
) const
{
...
template<class BasePhaseSystem>
Foam::tmp<Foam::volScalarField>
Foam::MomentumTransferPhaseSystemExtend<BasePhaseSystem>::Vm
(
    const phasePairKey& key
) const
{
...
template<class BasePhaseSystem>
void Foam::MomentumTransferPhaseSystemExtend<BasePhaseSystem>::addDmdtUfs
(
...
template<class BasePhaseSystem>
Foam::MomentumTransferPhaseSystemExtend<BasePhaseSystem>::
MomentumTransferPhaseSystemExtend
(
    const fvMesh& mesh
)
:
    BasePhaseSystem(mesh),
    filterPtr_(LESfilter::New(mesh, this)),
    filter_(filterPtr_())
{
...
Foam::MomentumTransferPhaseSystemExtend<BasePhaseSystem>::momentumTransfer()
{
    ...
    {
        *Kds_[dragModelIter.key()] = filter_(dragModelIter()->K());
        *Kdfs_[dragModelIter.key()] = dragModelIter()->Kf();
	if(this->mesh_.time().outputTime())
	{
	    Kds_[dragModelIter.key()]->write();
	}
    }
...
template<class BasePhaseSystem>
Foam::autoPtr<Foam::phaseSystem::momentumTransferTable>
Foam::MomentumTransferPhaseSystemExtend<BasePhaseSystem>::momentumTransferf()
{
    // Create a momentum transfer matrix for each phase
    autoPtr<phaseSystem::momentumTransferTable> eqnsPtr
    (
...
Foam::MomentumTransferPhaseSystemExtend<BasePhaseSystem>::AFfs() const
{
...
template<class BasePhaseSystem>
Foam::PtrList<Foam::surfaceScalarField>
Foam::MomentumTransferPhaseSystemExtend<BasePhaseSystem>::phiFs
(
...
template<class BasePhaseSystem>
Foam::PtrList<Foam::surfaceScalarField>
Foam::MomentumTransferPhaseSystemExtend<BasePhaseSystem>::phiFfs
(
...
template<class BasePhaseSystem>
Foam::PtrList<Foam::surfaceScalarField>
Foam::MomentumTransferPhaseSystemExtend<BasePhaseSystem>::phiKdPhis
(
    const PtrList<volScalarField>& rAUs
) const
{
...
template<class BasePhaseSystem>
Foam::PtrList<Foam::surfaceScalarField>
Foam::MomentumTransferPhaseSystemExtend<BasePhaseSystem>::phiKdPhifs
(
    const PtrList<surfaceScalarField>& rAUfs
) const
{
...
Foam::MomentumTransferPhaseSystemExtend<BasePhaseSystem>::KdUByAs
(
    const PtrList<volScalarField>& rAUs
) const
{
...
template<class BasePhaseSystem>
bool Foam::MomentumTransferPhaseSystemExtend<BasePhaseSystem>::
...
template<class BasePhaseSystem>
Foam::PtrList<Foam::surfaceScalarField>
Foam::MomentumTransferPhaseSystemExtend<BasePhaseSystem>::DByAfs
(
    const PtrList<volScalarField>& rAUs,
    const PtrList<surfaceScalarField>& rAUfs
) const
...
template<class BasePhaseSystem>
Foam::PtrList<Foam::surfaceScalarField>
Foam::MomentumTransferPhaseSystemExtend<BasePhaseSystem>::ddtCorrByAs
(
    const PtrList<volScalarField>& rAUs,
...
template<class BasePhaseSystem>
void Foam::MomentumTransferPhaseSystemExtend<BasePhaseSystem>::partialElimination
(
    const PtrList<volScalarField>& rAUs,
...
template<class BasePhaseSystem>
void Foam::MomentumTransferPhaseSystemExtend<BasePhaseSystem>::partialEliminationf
(
    const PtrList<surfaceScalarField>& rAUfs,
    const PtrList<surfaceScalarField>& alphafs,
...
template<class BasePhaseSystem>
bool Foam::MomentumTransferPhaseSystemExtend<BasePhaseSystem>::read()
{
