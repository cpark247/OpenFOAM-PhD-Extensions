...
const IDDESDelta& kOmegaSSTIDDES<BasicMomentumTransportModel>::setDelta() const
{
...
template<class BasicMomentumTransportModel>
tmp<volScalarField> kOmegaSSTIDDES<BasicMomentumTransportModel>::alpha() const
{
    return max
    (
...
template<class BasicMomentumTransportModel>
tmp<volScalarField> kOmegaSSTIDDES<BasicMomentumTransportModel>::ft
(
    const volScalarField& magGradU
) const
{
    Info << "ID DES ft() going through" << endl;
    return tanh(pow3(sqr(Ct_)*rd(this->nut_, magGradU)));
}
 
 
template<class BasicMomentumTransportModel>
tmp<volScalarField> kOmegaSSTIDDES<BasicMomentumTransportModel>::fl
(
    const volScalarField& magGradU
) const
{
    Info << "ID DES fl() going through" << endl;
    return tanh(pow(sqr(Cl_)*rd(this->nu(), magGradU), 10));
}

template<class BasicMomentumTransportModel>
tmp<volScalarField> kOmegaSSTIDDES<BasicMomentumTransportModel>::rd
(
    const volScalarField& nur,
    const volScalarField& magGradU
) const
{
    Info << "ID DES rd() going through" << endl;
...
template<class BasicMomentumTransportModel>
tmp<volScalarField> kOmegaSSTIDDES<BasicMomentumTransportModel>::fdt
(
    const volScalarField& magGradU
) const
{
    Info << "ID DES fdt() going through" << endl;
    return 1 - tanh(pow(Cdt1_*rd(this->nut_, magGradU), Cdt2_));
}

template<class BasicMomentumTransportModel>
tmp<volScalarField> kOmegaSSTIDDES<BasicMomentumTransportModel>::dTilda
(
    const volScalarField& magGradU,
    const volScalarField& CDES
) const
{
    Info << "ID DES dTilda() going through" << endl;
...
template<class BasicMomentumTransportModel>
kOmegaSSTIDDES<BasicMomentumTransportModel>::kOmegaSSTIDDES
(
...
template<class BasicMomentumTransportModel>
bool kOmegaSSTIDDES<BasicMomentumTransportModel>::read()
{
    if(kOmegaSSTDES<BasicMomentumTransportModel>::read())
    {
